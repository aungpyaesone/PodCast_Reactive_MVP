...
class LatestPodCastListAdapter(val mDelegate:LatestEpisodeDelegate) : BaseAdapter<BaseViewHolder<RandomPodcastVO>,RandomPodcastVO>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder<RandomPodcastVO> {
