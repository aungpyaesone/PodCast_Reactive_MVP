...
class DownloadedListAdapter(val mDelegate: DownloadedItemDelegate) : BaseAdapter<BaseViewHolder<DownloadVO>,DownloadVO>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder<DownloadVO> {
